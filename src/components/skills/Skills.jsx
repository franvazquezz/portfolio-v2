...
import {SiExpress, SiJavascript, SiNextdotjs, SiPostgresql, SiRedux, SiTailwindcss, SiTypescript} from "react-icons/si";
				...
				<div className="flex md:flex-col ">
					<div className="left flex-1 w-full">
						...
						<div data-aos="zoom-in" className="progress flex items-center h-[100%] justify-end md:justify-center">
							<div className=" flex flex-col gap-6  w-3/4  my-5 md:w-[90%]">
								...
								<ProgressBar logo={<SiJavascript />} name={"Javascript"} value={100} />
								<ProgressBar logo={<FaReact />} name={"React.js"} value={100} />
								<ProgressBar logo={<SiRedux />} name={"Redux"} value={78} />
								<ProgressBar logo={<SiTailwindcss />} name={"Tailwind CSS"} value={100} />
								<ProgressBar logo={<SiTypescript />} name={"Typescript"} value={100} />
								<ProgressBar logo={<SiNextdotjs />} name={"Next.js"} value={90} />
							</div>
						</div>
					</div>
					{/* right box */}
					<div className="right relative flex-1 flex flex-wrap p-5 gap-10 items-center justify-center sm:w-full">
						<div className="first2 flex flex-col gap-10">
							...
							<SkillBox logo={<SiPostgresql />} black={"white"} white={"black"} skill={"PostgreSQL"} />
						</div>
						<div className="last2 flex flex-col gap-10">
							<SkillBox logo={<SiExpress />} black={"black"} white={"white"} skill={"Express.js"} />
							{/* <SkillBox
                className=""
                logo={
                  <SiTypescript/>
